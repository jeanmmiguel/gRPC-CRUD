...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserById = channel.unary_unary(
                '/Users/GetUserById',
                request_serializer=users__pb2.GetUsersByIdRequest.SerializeToString,
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserById': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=users__pb2.GetUsersByIdRequest.FromString,
...
class Users(object):
    ...
    def GetUserById(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Users/GetUserById',
            users__pb2.GetUsersByIdRequest.SerializeToString,
